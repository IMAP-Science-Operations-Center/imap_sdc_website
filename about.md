...
- Define code standards in the SDC Software Developer Guide [link to this?] for the development of processing software.
...
- Provide integration and automation support to Combined Access and Visualization Analysis (CAVA) [link?].
...
More information about the IMAP mission and its science goals can be found on the official [IMAP website](https://imap.princeton.edu). More information about the IMAP SDC can be found in the [SDC documentation](link-to-sdc-docs) [what should this link to exactly?].

## How to Access the Data

Data can be accessed through this website via the [data portal](link-to-data-portal) [need link to this].
